                                        ...
                                        const lv_draw_line_dsc_t *dsc)
{
    ...
    if (point1->y == point2->y)
        draw_line_hor(point1, point2, &clip_line, dsc);
    else if (point1->x == point2->x)
        draw_line_ver(point1, point2, &clip_line, dsc);
    else
        draw_line_skew(point1, point2, &clip_line, dsc);
                                                 ...
                                                 const lv_draw_line_dsc_t *dsc)
{
    ...
    int32_t wcorr_i = 0;
    if (flat)
        wcorr_i = (LV_MATH_ABS(ydiff) << 5) / LV_MATH_ABS(xdiff);
    else
        wcorr_i = (LV_MATH_ABS(xdiff) << 5) / LV_MATH_ABS(ydiff);
